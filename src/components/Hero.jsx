  ...
  return (
    <div className="grid lg:grid-cols-2 gap-24 items-center">
      <div>
        ...
        <p className="mt-8 max-w-xl text-lg leading-8">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eum minima repellendus tempore velit, architecto perferendis dicta ullam sequi sint pariatur odio? Adipisci quia quo fuga, quisquam dignissimos nihil vitae deleniti?</p>
        <div className="mt-10">
